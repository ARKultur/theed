    ...
    view: function (_vnode) {
        return m('a', {
            'class': 'inline-flex items-center justify-center w-full px-5 py-3 ' +
                'text-sm font-medium text-center text-gray-900 border border-gray-200' +
                ' rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 ' +
            ...
            'xmlns': 'public/images/stylish-logo.svg',
            'viewBox': '0 0 496 512',
        },
            m('path', {
